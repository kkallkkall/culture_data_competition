...
line2_transfer_stations_하차인원.to_csv('2호선환승역.csv', index=False,encoding='utf-8-sig')
line5_transfer_stations_하차인원.to_csv('5호선환승역.csv', index=False,encoding='utf-8-sig')
line6_transfer_stations_하차인원.to_csv('6호선환승역.csv', index=False,encoding='utf-8-sig')
