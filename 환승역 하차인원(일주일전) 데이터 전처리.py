...
line2_transfer_stations_하차인원.rename(columns={'날짜': '행사 일주일 전 날짜'}, inplace=True)
line5_transfer_stations_하차인원.rename(columns={'날짜': '행사 일주일 전 날짜'}, inplace=True)
line6_transfer_stations_하차인원.rename(columns={'날짜': '행사 일주일 전 날짜'}, inplace=True)
